...
public final class ControlViewModel {
  public final StartProgramViewModel database = new StartProgramViewModel();
  public final StartProgramViewModel account = new StartProgramViewModel();
  public final StartProgramViewModel logger = new StartProgramViewModel();
  public final StartProgramViewModel core = new StartProgramViewModel();
  public final StartProgramViewModel game = new StartProgramViewModel();
  public final StartProgramViewModel role = new StartProgramViewModel();
  public final StartProgramViewModel login = new StartProgramViewModel();
  public final StartProgramViewModel rank = new StartProgramViewModel();
   ...
   * 启动程序视图模型。
   */
  public static final class StartProgramViewModel {
    ...
    public final StringProperty text = new SimpleStringProperty(TEXT_STOPPED);
    public final Property<Paint> color = new SimpleObjectProperty<>(COLOR_STOPPED);
    ...
    public void checkEnabled(boolean enabled) {
      if (!enabled) {
   ...
   * 启动模式视图模型。
   */
  public static final class StartModeViewModel {
    ...
    public final StringProperty modeValue = new SimpleStringProperty();
    public final BooleanProperty hoursDisable = new SimpleBooleanProperty(true);
    public final ObjectProperty<SpinnerValueFactory<Integer>> hoursValue =
        new SimpleObjectProperty<>(HOURS_VALUE_FACTORY);
    public final BooleanProperty minutesDisable = new SimpleBooleanProperty(true);
    public final ObjectProperty<SpinnerValueFactory<Integer>> minutesValue =
   ...
   * @author qiang.zhang
   */
  public static final class ConsoleViewModel {
   ...
   * @author qiang.zhang
   */
  public static final class StartGameViewModel {
